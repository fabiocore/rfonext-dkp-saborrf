...
- **Lance mínimo** (corrigido em 2026-08-09): se o item tem Proteção com lance mínimo configurado (ex: 30), o **primeiro** lance pode ser exatamente esse valor — não precisa ser 31. O "+1" só se aplica quando já existe um lance líder (precisa **superar** o valor atual, nunca empatar). Bug anterior somava +1 sempre, mesmo sem nenhum lance ainda.
