...
- **Vínculo personagem↔conta** (`Character.linkedUserId`, adicionado em 2026-08-09): opcional, um personagem Principal por conta, configurado na tela de Personagens. Quando o dono de uma conta GM/Vice-GM/Conselho pede atualização de nível pelo **próprio** personagem vinculado via `/perfil`, aplica **na hora** (sem passar pela fila de aprovação) — já que essa pessoa podia editar o nível livremente pela tela de Personagens mesmo; fica registrado como já aprovado (histórico consistente). Personagem sem vínculo continua sempre passando pela fila normal.
